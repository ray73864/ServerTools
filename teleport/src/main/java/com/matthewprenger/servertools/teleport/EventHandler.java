...
public class EventHandler {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        if (event.entity instanceof EntityPlayer && !(event.entity instanceof FakePlayer)) {
            ...
            ServerToolsTeleport.log.getLogger().trace("Set back location for Player: {} to DIM:{}, X:{}, Y:{}, Z:{}", player.worldObj.provider.dimensionId, player.posX, player.posY, player.posZ);
        }
    }
}
